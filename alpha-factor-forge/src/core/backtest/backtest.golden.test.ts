...
const GOLDEN_CASES: Array<{ name: string; config: BacktestConfig; expected: GoldenExpectation }> = [
  {
    ...
    expected: {
      ...
      netReturn: -0.0010085934863817148,
      maxDrawdown: 0.05396155392190526,
      sharpe: 0.04394147544153263,
    },
  },
  {
  ...
  },
  {
    ...
    expected: {
      ...
      netReturn: -0.004380911687054123,
      maxDrawdown: 0.05306273032179957,
      sharpe: -0.3019449099104298,
    },
  },
  {
    ...
    expected: {
      ...
      netReturn: -0.043193603945086534,
      maxDrawdown: 0.06500830637941346,
      sharpe: -4.293152440340766,
    },
  },
];
