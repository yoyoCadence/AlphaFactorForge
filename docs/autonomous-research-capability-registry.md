...
| 試驗帳本、樣本長度／內層 walk-forward、block-bootstrap／Holm | 可規劃 | 試驗計數不可重設與試驗種類分類待 P12b；精度預檢的 `priorTrials` 目前由呼叫端提供 | P12 |
...
- 不依賴 AI 的 phase（P04–P14、P18–P19）依賴皆已到位，可依序規劃；P01、P02、P03a、P03b、P04a、P04b、P05、P06、P07 已完成。
