...
- [x] **MARKETING-CAMPAIGN-001** — completed a repository-grounded Traditional Chinese product marketing campaign for AlphaFactorForge (2026-08-09, branch `feat/product-marketing-campaign`).
  ...
  - Claims are traceable to implementation and E2E evidence for the complete backtest workspace, Holdout comparison, 1–2 axis / 256-combination in-sample sweep, bar replay, immutable result context, and JSON/CSV export. Discovery UI, AI automation, overfitting elimination, and demo-performance claims are explicitly rejected.
  ...
  - Integrated the campaign hero, evidence-backed Traditional Chinese product introduction, verified feature highlights, and limitations disclosure into the root `README.md`.
