...
- [x] **RS-CORE-003** — pure Rust params-signals, validation-split, and embargo-derivation parity (PR #66 Resolution slice 3).
  ...
  - Validation: `npm run typecheck`; `npm test` (318); `npm run build`; `cargo check --locked`; `cargo test --locked` (38); targeted `rustfmt --check` clean; fixture regeneration blob-identical; e2e untouched (no UI/mock surface).
