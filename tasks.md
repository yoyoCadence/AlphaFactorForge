...
- Next: RS-CORE-004 (deterministic benchmarks + mulberry32/Random Entry parity) is implemented — RS-CORE-005 (Gate + Score structural parity) is next, followed by RUNNER-CONFIG/STORE/EXEC and RUNNER-UI in order.
...
- [ ] Discovery-runner program — next slice RS-CORE-005 (Gate + Score structural parity), then strictly ordered: RUNNER-CONFIG-001 → RUNNER-STORE-001 → RUNNER-EXEC-001 → RUNNER-UI-001.
