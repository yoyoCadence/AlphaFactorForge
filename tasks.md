...
- [x] **BUG-RESULT-CONTEXT-001 (P1)** — bind every completed interactive backtest to an immutable execution snapshot (completed locally 2026-07-31 on `fix/backtest-result-context`, branched from `origin/main` `0ebe6a8`).
