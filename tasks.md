...
- [ ] UI port — Slice 7-3: strategy library. Slice 7-1 (pure export formatters) and Slice 7-2 (export UI + file write) done; then backlog Slice 10 (chart pan/zoom) + Slice 8b (real Tauri window). See the slice plan under In Progress.
