...
> **P08（2026-09-20）已完成 ETF 日線純核心契約**：股息應收／付款、分割、原幣成本與實際時間年化，並有 TS／Rust 共用驗證案例。開發介面與限制見 [ETF 語意說明](docs/etf-semantics-v1.md)。真實 ETF 資料下載及成交／paper 接線仍待後續 phase；目前 UI 回測沿用既有契約。
